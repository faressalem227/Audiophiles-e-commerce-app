    ...
    <footer className="bg-black text-white  ">
      <div className="container flex flex-col gap-5 p-5  mx-auto text-center md:text-left  ">
        <div className="md:flex md:flex-col md:items-start md:justify-center  lg:flex-row lg:justify-between lg:items-center">
          <div className="flex flex-col mb-7 text-lg space-y-2 md:space-y-0 md:space-x-6 md:flex-row justify-center font-bold ">
            audiophile
          </div>
        ...
        <div className="md:flex  md:flex-row md:justify-between md:items-center">
          ...
          <div className="flex justify-center space-x-4 mt-7 mb-2">
